...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    {
        public static IHostBuilder DetectIncorrectUsageOfTransientDisposables(this IHostBuilder builder)
        {
            builder
                .UseServiceProviderFactory(new DetectIncorrectUsageOfTransientDisposablesServiceFactory())
                .ConfigureServices(s => s.TryAddEnumerable(ServiceDescriptor.Scoped<CircuitHandler, ThrowOnTransientDisposableHandler>()));
